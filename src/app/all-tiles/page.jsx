...
const AllTilesPage = () => {
    ...
    return (
        <div className="container mx-auto">
            ...
            <div className="my-6 flex justify-between max-md:flex-col max-md:gap-3 max-md:items-center">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-6 my-6 p-6">
